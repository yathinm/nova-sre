...
The checked-in React app is the frontend control panel. The stats frontend is still
**Grafana**; run `make port-forward-grafana` after Terraform installs the Helm
